...
new Promise((resolve, reject) => {
    ...
    x` + planeta.singular + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findAll(
            ...
            .catch(err => errorHandler(err, 'x`+ _.capitalize(modelo.singular) + planeta.plural + `', res))
    ...
    ` + planeta.singular + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.id )
            ...
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, '`+ _.capitalize(modelo.singular) + planeta.plural + `', res))
    ...
    ligar` + planeta.plural + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.` + modelo.singular + `)
            .then(item => item.$set('`+  _.capitalize(planeta.singular)  + `', req.params.` + planeta.singular + `))
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, 'ligar`+ _.capitalize(modelo.singular) + planeta.plural + `', res))

    //* `+ planeta.id + `
    desligar` + planeta.plural + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.` + modelo.singular + `)
            .then(item => item.$remove('`+  _.capitalize(planeta.singular)  +`', req.params.` + planeta.singular + `))
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, 'desligar`+ _.capitalize(modelo.singular) + planeta.plural + `', res))
    ...
    ` + _.toLower(planetax.orbitas.alias) + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.id)
            ...
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, '`+ _.capitalize(modelo.singular) + planetax.orbitas.alias + `', res))

    //* `+ planeta.id + `
    ligar` + _.toLower(planetax.orbitas.alias) + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.` + modelo.singular + `)
            .then(item => item.$add('`+  planetax.orbitas.alias  + `', req.params.` + planetax.singular + `, { through :  req.body ? req.body : null }))
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, 'ligar`+ _.capitalize(modelo.singular) + planetax.orbitas.alias + `', res))
    ...
    desligar` + _.toLower(planetax.orbitas.alias) + ` = (req: Request, res: Response, next: NextFunction) =>
        `+ _.capitalize(modelo.singular) +`.findById(req.params.` + modelo.singular + `)
            ...
            .then(result => res.status(200).jsonp(result))
            .catch(err => errorHandler(err, 'desligar`+ _.capitalize(modelo.singular) + planetax.orbitas.alias + `', res))
    ...
    `+ _.capitalize(modelo.singular) +`.findById(req.params.id)
        ...
        .then(result => res.status(200).jsonp(result))
        .catch(err => errorHandler(err, 'sub`+ _.capitalize(modelo.singular) + planeta.plural + `', res))
    ...
    `+ _.capitalize(modelo.singular) +`.findById(req.params.id)
        ...
        .then(result => res.status(200).jsonp(result))
        .catch(err => errorHandler(err, 'pre`+ _.capitalize(modelo.singular) + planeta.plural + `', res))
