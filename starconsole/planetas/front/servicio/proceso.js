...
`)
    ...
    public static ligar` + _.toLower(planetax.orbitas.alias)  + ` = (`+  modelo.singular  +` , ` +  planetax.singular  + `, objeto ) => axios.default.put( url + '/data/` +  modelo.singular  + `-` +  planetax.singular  + `-` + _.lowerCase(planetax.orbitas.alias) + `/' + `+  modelo.singular  +` + '/' + `+  planetax.singular  + `, objeto )
    public static desligar` +  _.toLower(planetax.orbitas.alias)  + ` = (`+  modelo.singular  +` , ` +  planetax.singular  + `) => axios.default.delete( url + '/data/`+  modelo.singular  + `-` +  planetax.singular  + `-` + _.lowerCase(planetax.orbitas.alias) + `/' + `+  modelo.singular  +` + '/' + `+  planetax.singular  +` )
